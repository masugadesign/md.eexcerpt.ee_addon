...
"Autogenerating an excerpt when a summary doesn't exist":http://expressionengine.com/forums/viewthread/43985/
...
* Added trim() ina couple places to keep things tidy
* Internal cleanup
